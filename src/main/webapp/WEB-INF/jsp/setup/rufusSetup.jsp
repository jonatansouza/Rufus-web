...
<html>
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">        <title>JSP Page</title>
    </head>
        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <form onSubmit="return alert('Setup Configured')" id="formSetup" class="form-horizontal" method="POST" action="${linkTo[SetupController].saveAddress}">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input value="${hosts[0].ip}" required type="text" name="web" class="form-control" id="rufusWeb" placeholder="192.168.1.101">
                    </div>
                </div>
                <div class="form-group">
                    <label for="rufusCore" class="col-sm-4 control-label">Rufus-Core</label>
                    <div class="col-sm-8">
                        <input value="${hosts[1].ip}" required type="text" name="core" class="form-control" id="rufusCore" placeholder="192.168.1.102">
                    </div>
                </div>
                <div class="form-group">
                    <label for="auth" class="col-sm-4 control-label">Auth</label>
                    <div class="col-sm-8">
                        <input value="${hosts[2].ip}" required type="text" name="auth" class="form-control" id="auth" placeholder="192.168.1.102">
                    </div>
                </div>
                <div class="form-group">
